import { extractHeadingsFromHtml, HtmlHeading } from '../index.js'
...
describe('extractHeadingsFromHtml', () => {
  ...
  it('should handle nested headings', () => {
    ...
    const result = extractHeadingsFromHtml(html)
    expect(result).toEqual([new HtmlHeading(1, 'Outer H1', undefined), new HtmlHeading(2, 'Inner H2', undefined)])
  })
  ...
  it('should handle malformed HTML', () => {
    ...
    const result = extractHeadingsFromHtml(html)
    expect(result).toEqual([new HtmlHeading(1, 'Broken HTML', undefined), new HtmlHeading(2, 'Still Works', undefined)])
  })
